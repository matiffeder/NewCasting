...
back:SetSize(192, 17)
back:SetTexture("Interface/Addons/NewCasting/Striped")
CastingBarFrame:SetLayers(1, back)
local tex = "Interface/Addons/NewCasting/Castborder"
...
CastingBarFlash:SetTexture("Interface/Addons/NewCasting/Castflash")
